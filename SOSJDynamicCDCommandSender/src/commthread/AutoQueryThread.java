 ...
 * @author Atmojo
 */
public class AutoQueryThread implements Runnable{
    String DevelAddr;
    String currReg;
    String currCDStats; 
    ...
    public AutoQueryThread(String DevelAddr, String currReg, String currCDStats,long periodMS){
    ...
    public void run() {
        ...
        while(SOSJCommandGUIMailbox.GetAutoQueryEnabledStat()){
