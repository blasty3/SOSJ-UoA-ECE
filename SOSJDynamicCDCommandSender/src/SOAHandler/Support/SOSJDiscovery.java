 ...
 * @author Udayanto
 */
public class SOSJDiscovery implements Runnable {
    
    String SSOrigin;
    String regID;
    String regAddr;
    
    public SOSJDiscovery(String SSOrigin,String regID, String regAddr){
        this.SSOrigin = SSOrigin;
        this.regID = regID;
        this.regAddr = regAddr;
    }
    
    public static synchronized JSONObject TransceiveDiscMsg(String DevelAddr,String regID, String regAddr){
        ...
        try{
                    ...
                    s = new MulticastSocket(198);
                                ...
                                String message = ConstructNoP2PServToRegDiscoveryMessage(DevelAddr, regID);
                                //while(true){
    ...
    private static String ConstructNoP2PServToRegDiscoveryMessage(String DevelAddr, String regID){
