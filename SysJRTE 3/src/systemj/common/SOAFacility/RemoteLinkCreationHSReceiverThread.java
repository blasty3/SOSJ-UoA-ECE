 ...
 * @author Udayanto
 */
public class RemoteLinkCreationHSReceiverThread implements Runnable{
        ...
        //     String connStat = netcheck.CheckNetworkConn("192.168.1.1", 1300);
           ...
           //     if (connStat.equalsIgnoreCase("Connected")){
            ...
            if (ss==null || !ss.isBound()){
                try {
                    ss = new ServerSocket(8890,50,InetAddress.getByName(SJServiceRegistry.getLocalSSAddr()));//new ServerSocket(8888, 50, getLocalHostLANAddress());
                   ...
                   if (migrMsg.equalsIgnoreCase("START")){
                       ...
                       Socket socketSend = new Socket(InetAddress.getByName(destAddr),8890);
                       ...
                       System.out.println("RemoteLinkCreation PairPortAlloc: " +PairPortAlloc);
                       ...
                       try{
                           ...
                           while(keysPair.hasMoreElements()){
                                ...
                                //if(!SS.equalsIgnoreCase(SJSSCDSignalChannelMap.getLocalSSName()) && SS.equals(SSPartnerName)){
                                if(SS.equals(SSPartnerName)){
                                    ...
                                    System.out.println("Remote Link interface addr: " +args+" is created!");
                                }
                            ...
                            //check if link has been established, if not, start TCP-IP thread
