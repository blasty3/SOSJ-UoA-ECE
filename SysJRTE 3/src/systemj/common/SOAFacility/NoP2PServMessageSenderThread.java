...
public class NoP2PServMessageSenderThread implements Runnable {
                    ...
                    if (connStat.equalsIgnoreCase("Connected")){
                     ...
                     //   if (!SOABuffer.getIsInitDiscDone() || !SOABuffer.getIsInitAdvDone()){
                                    ...
                                    if(registryHash.length()>0){
                                        ...
                                        Enumeration keyAvailReg = registryHash.keys();
                                            ...
                                            while(keyAvailReg.hasMoreElements()){
                                                ...
                                                String AdvMsg = sjdisc.ConstructServToRegReAdvertisementMessageOfInclServ(Long.toString(SJServiceRegistry.getOwnAdvertisementTimeLimit()), LocalSSName, regID);
                                                
                                                try {
                                                    String regAddr = registryHash.getString(regID);
                                                    
                                                    if(regAddr.equalsIgnoreCase(SJServiceRegistry.getOwnIPAddressFromRegistry()) || regAddr.equalsIgnoreCase("127.0.0.1") || regAddr.equalsIgnoreCase("localhost")){
                            ...
                            while(keysAllRegDet.hasMoreElements()){
                                ...
                                if(timeRem>=0.6*expiry){
                                    
                                    String regReqAdv = sjdisc.ConstructRegRequestAdvertisementMessage(regAddr,SJServiceRegistry.getOwnIPAddressFromRegistry());
                                    
                                    if(regAddr.equals(SJServiceRegistry.getOwnIPAddressFromRegistry()) || regAddr.equalsIgnoreCase("127.0.0.1") || regAddr.equalsIgnoreCase("localhost")){
                                     ...
                                     if(SJServiceRegistry.obtainInternalRegistryVisibleProviderOnly().length()>0){
                                         ...
                                         JSONObject generatedRespAdvMsgJSON = ProcessMessageInJSON(jsReqAdvMsg.toString(), SJServiceRegistry.obtainInternalRegistryVisibleProviderOnly().toString());     
                                            ...
                                            try {
                                                ...
                                                destAddr = generatedRespAdvMsgJSON.getString("destAddr");
    ...
    private JSONObject ProcessMessageInJSON(String SJMessage,String OfferedServices)
    {
        ...
        try {
            ...
            */
            if (jsMsg.getString("MsgType").equalsIgnoreCase("regToProvRequestAdvertise")){
                ...
                processedSJMessage = sjdisc.ConstructNoP2PProvToRegResponseReAdvertisementMessageInJSON(Long.toString(SJServiceRegistry.getOwnAdvertisementTimeLimit()), destIPAddr, LocalSSName);
