 ...
 * @author Udayanto
 */
public class RegLocalMessageReceiverThread implements Runnable{
                                                                        ...
                                                                        else
                                                                        {
                                                                           if(infoDebug == 1) System.out.println("Direct assign the received byffer to the value 3");
                                                                            ...
                                                                            //put the disc msg to the suitable buffer for accordingly response by the sender thread
                                                                                ...
                                                                                */
                                                                                if (msgType.equalsIgnoreCase("reAdvertise")){


                                                                                //if (SJServiceRegistry.HasServiceConsumerOrProvider()){

                                                                                    //System.out.println("MessageReceiverThread, Storing advertisement: " +jsMsg);

                                                                                    //SJServiceRegistry.SaveJoiningNodesServicesInfoOfSOAMsg(jsMsg);
                                                                                    SJServiceRegistry.SaveJoiningNodesServicesInfoOfSOAMsgNoP2P(js);

                                                                                /*
                                                                                    try {
                                                                                        System.out.println("RegLocalMessageRcvrThread, Current Registry content: " +SJServiceRegistry.obtainCurrentRegistry());
                                                                            ...
                                                                            */
                                                                            ...
                                                                            //put the req adv to the appropriate buffer
                                                                                ...
                                                                                //System.out.println("MsgReceiverThread, receive reqAdv: " +jsMsg);
