    ...
    private void ResponseMigAndLinkReq(JSONObject reqMsg){
        ...
        try {
            ...
            if(msgType.equals("reqLinkCreation")){
                ...
                if(reqMsg.getString("sourceAddress").equalsIgnoreCase(SJServiceRegistry.getLocalSSAddr())){
                ...
                //String destAddress = "224.0.0.100";
                                    String destSS = reqMsg.getString("sourceSS");
                                    ...
                                    if(CDLCBuffer.GetLinkCreationBusyFlag()){
                                        ...
                                        if(destAddress.equals(SJServiceRegistry.getLocalSSAddr())){
