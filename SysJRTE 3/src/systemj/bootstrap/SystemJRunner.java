...
import systemj.common.SOAFacility.RegLocalDiscMessageReceiverThread;
import systemj.common.SOAFacility.RegLocalMessageReceiverThread;
import systemj.common.SOAFacility.RegMessageSenderThread;
...
public class SystemJRunner
{
	...
	public static void main(InputStream input){
        ...
        private static void setRegAdvExpiryTime(){
            SOABuffer.setSOSJRegExpiryTime(SOSJRegAdvExpiryTime);
        }
        ...
        /*
        private static void StartSOSJP2PThread(){
            Thread expirychecker = new Thread(new ExpiryCheckerThread());
            Thread msgreceiver = new Thread(new MessageReceiverThread());
            Thread msgsender = new Thread(new MessageSenderThread());
            Thread migMsgRec = new Thread(new MigrationAndLinkReqMsgRecThread());
            Thread migLocMsgRec = new Thread(new MigrationAndLinkLocalReqMsgRecThread());
        ...
        */
        ...
        private static void StartSOARegThread(){
            ...
            Thread locregmsgreceiver = new Thread(new RegLocalMessageReceiverThread());
            Thread locregdiscmsgreceiver = new Thread (new RegLocalDiscMessageReceiverThread());
            //Thread remregdiscmsgreceiver = new Thread(new RegRemoteDiscMessageReceiverThread());
            Thread regmsgsender = new Thread(new RegMessageSenderThread());
